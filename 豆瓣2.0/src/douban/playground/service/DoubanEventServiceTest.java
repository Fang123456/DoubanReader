...
import douban.service.DoubanEventService;
import douban.service.DoubanEventService.EventType;
 ...
 */
public class DoubanEventServiceTest {
...
//    assertTrue(result.getTitle().contains("��־�ɽ�ɽ"));
//  }
//
//  /**
