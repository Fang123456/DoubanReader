...
import douban.model.v2.DoubanSubjectListObj;
...
public class DoubanBookMovieMusicService extends DoubanService {
    ...
    public douban.model.v2.DoubanSubjectObj getV2MovieInfoById(long movieId) throws DoubanException, IOException {
        String url = RequestUrls.DOUBAN_MOVIE_V2_SUBJECT_PREFIX + "/" + movieId;
        douban.model.v2.DoubanSubjectObj movie = this.client.getResponseInJson(url, null, douban.model.v2.DoubanSubjectObj.class, false);
        return movie;
    }
